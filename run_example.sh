...
########################################################
# This script runs the example translation agent
#
# It can be reused to run any other agent
#
...
java -Djava.library.path=$LIBJPL_DIR -Dfile.encoding=UTF-8 -classpath $CLASSPATH jadex.base.Starter
